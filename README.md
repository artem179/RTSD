...
попробовать улучшить качество: подбирать картинки в batch в определенных пропорциях (чтобы сохранялось соотношение 
между классами), попробовать 
[DSSD](https://arxiv.org/pdf/1701.06659.pdf), попробовать различные варианты аугментации и т.д. 
